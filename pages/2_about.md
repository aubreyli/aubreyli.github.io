...
## About the site
This is a personal website of Aubrey Li, created with github and jekyll.
...
### Admin tools
* site [configuration file](https://github.com/aubreyli/aubreyli.github.io/blob/master/_config.yml)
...
My primary research interest is in Linux kernel, machine learning and python data analysis. See my project page for details.
